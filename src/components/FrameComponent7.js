...
const FrameComponent7 = () => {
  ...
  return (
    <div className="frame-parent3">
      ...
      <b className="tata-communications">NET ZERO BY 2035</b>
    </div>
        <div className="climate-targets-approved-container">
          <p className="climate-targets">ACCELERATING THE 
</p>
          <p className="climate-targets">3C SUSTAINABILITY</p>
          <p className="climate-targets">STRATEGY</p>
        </div>
      </div>
